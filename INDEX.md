...
- 真实点击成本 (Actual Cost Per Click, Actual CPC)
- 展示次数 (Impressions)
- 点击率 (Click Through Rate, CTR)
- 转化率 (Conversion Rate, CVR)
- 单次获客成本 (Cost Per Acquisition, CPA)
- 匹配类型 (Match Type)

### 数据驱动营销

- 数据驱动营销 (Data Driven Marketing)
- Amazon Prime Video 数据集
- 每日累计观看时长 (`cvt_per_day`)
- 数值预测模型 (Numeric Prediction Model)
